                        ...
                        .with_node_children(|parent| {
                            ...
                            parent.spawn_bundle(TextBundle {
                                style: Style {
                                    ...
                                    right: Units::Pixels(5.0),
                                    top: Units::Pixels(5.0),
                        ...
                        .with_children(|parent| {
                            parent.spawn_bundle(NodeBundle {
                                style: Style {
                                    ...
                                    height: Units::Pixels(100.0),
                                    position_type: PositionType::SelfDirected,
                                    left: Units::Pixels(20.0),
                                    bottom: Units::Pixels(20.0),
                                    // position: Rect {
                                    //     left: Val::Px(20.0),
                                    //     bottom: Val::Px(20.0),
                                    //     ..Default::default()
                            ...
                            parent.spawn_bundle(NodeBundle {
                                style: Style {
                                    ...
                                    height: Units::Pixels(100.0),
                                    position_type: PositionType::SelfDirected,
                                    left: Units::Pixels(60.0),
                                    bottom: Units::Pixels(60.0),
                            ...
                            parent.spawn_bundle(NodeBundle {
                                style: Style {
                                    ...
                                    height: Units::Pixels(100.0),
                                    position_type: PositionType::SelfDirected,
                                    left: Units::Pixels(80.0),
                                    bottom: Units::Pixels(80.0),
                                    ..Default::default()
                                },
